 ...
 *
 * version 4 - using MongoDB with mongoose
 */
...
function attempt_signup(signup_data, ee, args){
	...
	check_username(signup_data, model, signup_emitter, "username");
    });
...
function check_username(signup_data, model, ee, event){
    /*
