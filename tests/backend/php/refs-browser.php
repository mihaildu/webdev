...
<html lang="en">
	 ...
	 * the session id (PHPSESSID) cookie allows you to login
	 * without a password
	 * session variables are stored on disk
	 *
	 * you can have logged in session without session variables
	 * e.g. you can generate a random string and pass it as a GET param
	 * you don't need to do that yourself, php has support for it
	 * (some ini params)
	 *
	 ...
	 * _GET, _POST, _REQUEST (merge between GET and POST)
	 * TODO test _REQUEST
	...
	/* you can also print large chunks of text like this
	 * I assume this is something like echo until END
	 * the last END; must appear like that on a new line
	 * this is called the here document
	 * */
	echo <<< END
